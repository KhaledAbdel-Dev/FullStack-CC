...
// message board routes ===============================================================
    ...
    app.post('/times', (req, res) => {
      db.collection('times').save({name: req.body.name, shift: req.body.shift, msg: req.body.msg}, (err, result) => {
        if (err) return console.log(err)
    ...
    app.put('/thumbup', (req, res) => {
      db.collection('times')
      .findOneAndUpdate({name: req.body.name, shift: req.body.shift, msg: req.body.msg}, {
        $set: {
